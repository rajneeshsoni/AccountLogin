...
import com.poc.accountLogin.model.ResponseBean;
import com.poc.accountLogin.util.ApiConstants;
import com.poc.accountLogin.util.ApiException;
...
public class CustomerExceptionHandler {
	...
	@ExceptionHandler(value = { MissingServletRequestParameterException.class, MissingPathVariableException.class,
			...
			ApiException.class, BadCredentialsException.class, InternalAuthenticationServiceException.class
